...
print_no_newline( "button(" "\"" arguments_of_line[2] "\"" "," "\"" arguments_of_line[2] "\"" ")" "+")
...
generate_page(){
    ...
    pagefile="$1"
    cat "/home/user/projects/flightdeckexperiences/generate_page.js" "$pagefile" | markdown_like_page_language > #/dev/stdout
    "/tmp/generate_page$$" ;node "/tmp/generate_page$$";rm "/tmp/generate_page$$";
